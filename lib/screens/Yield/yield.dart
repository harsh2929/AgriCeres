...
import 'package:AgroCeres/screens/Yield/final.dart';
...
class _FirebaseRealtimeDemoScreenState
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          AppLocalizations.of(context).translate('Crop Prediction'),
        ),
        centerTitle: true,
      ),
      body: Center(
    ...
    return new Column(
      children: <Widget>[
        ...
        new RaisedButton(
          ...
          child: new Text(AppLocalizations.of(context).translate('Send')),
        )
      ],
    );
  }
